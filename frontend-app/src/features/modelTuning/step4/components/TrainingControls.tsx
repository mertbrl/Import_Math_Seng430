...
export const ParamSlider: React.FC<{
  ...
  <div className="space-y-1.5">
    <div className="flex items-center justify-between gap-3">
      ...
      <span className="rounded-lg border border-indigo-100 bg-indigo-50 px-2 py-0.5 text-sm font-black text-indigo-600">
...
export const SelectField: React.FC<{
  ...
  <div className="space-y-1.5">
    ...
    <select
      ...
      className="w-full rounded-xl border-2 border-slate-200 bg-white px-3 py-2 text-sm text-slate-800 focus:border-indigo-500 focus:outline-none"
    >
      {options.map((option) => (
