    ...
    <nav className="ha-navbar">
      <div className="page-wrap-wide flex min-h-[72px] flex-col gap-4 py-4 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex min-w-0 items-center gap-4">
          ...
          <div className="min-w-0">
            <div className="flex flex-wrap items-center gap-2">
              <h1 className="ha-topbar-brand-title truncate font-[var(--font-display)] text-[22px] font-bold tracking-[-0.05em] text-[var(--text)]">
                Health AI
              </h1>
              <span className="ha-pill ha-topbar-domain-chip">{currentDomain.domainName}</span>
            </div>
            <p className="ha-topbar-subtitle mt-1 text-sm text-[var(--text3)]">
        ...
        <div className="flex flex-wrap items-center gap-3 lg:justify-end">
          ...
          <div className="ha-pill ha-topbar-step-pill">
