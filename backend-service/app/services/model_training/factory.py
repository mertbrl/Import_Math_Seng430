...
class SklearnEstimatorFactory:
    def create(self, algorithm: str, params: dict[str, Any], *, class_count: int = 2) -> Any:
        estimator_params = self.to_estimator_params(algorithm, params, class_count=class_count)
    ...
    def to_estimator_params(self, algorithm: str, params: dict[str, Any], *, class_count: int = 2) -> dict[str, Any]:
        if algorithm == "knn":
            return {
    ...
    def to_model_params(self, algorithm: str, estimator_params: dict[str, Any]) -> dict[str, Any]:
        if algorithm == "knn":
            return {
